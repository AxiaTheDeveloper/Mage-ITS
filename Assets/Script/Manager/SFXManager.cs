...
public class SFXManager : MonoBehaviour
{
    ...
    [SerializeField]private AudioSource buttonCanBeUsed_SFX, buttonCantBeUsed_SFX, onDrag__SFX, onDragRelease_SFX, rotate__SFX, win_SFX, capacitorOn_SFX, noStars_SFX;
    ...
    public void UpdateSFX_Volume(){
        ...
        if(capacitorOn_SFX)capacitorOn_SFX.volume = volume;
    ...
    public void PlayCapacitorOn()
    {
        if(capacitorOn_SFX)capacitorOn_SFX.Play();
    }
    public void PlayNoStars()
    {
        if(noStars_SFX)noStars_SFX.Play();
    }
